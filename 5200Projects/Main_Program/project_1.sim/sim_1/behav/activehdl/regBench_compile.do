######################################################################
#
# File name : regBench_compile.do
# Created on: Fri Mar 08 22:11:41 -0600 2019
#
...
eval vcom -93 $vcom_opts -work xil_defaultlib  \
	"$origin_dir/../../../../project_1.srcs/sources_1/new/REGTABLE.vhd" \
	"$origin_dir/../../../../project_1.srcs/sim_1/new/regBench.vhd" \
